...
namespace Ch11
{
    public partial class Form2 : Form
    {
        ...
        private void Form2_Load(object sender, EventArgs e)
        {
            ...
            member.Add(new Member("a101", "김유신", "010-1234-1001", 24));
            member.Add(new Member("a102", "김춘추", "010-1234-1002", 21));
            member.Add(new Member("a103", "장보고", "010-1234-1003", 34));
            member.Add(new Member("a104", "강감찬", "010-1234-1004", 44));
            member.Add(new Member("a105", "이순신", "010-1234-1005", 54));
