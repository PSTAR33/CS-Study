...
namespace Ch02
{
    internal class _3_Operator
    {
        static void Main3(string[] args)
        {
            ...
            bool rs5 = var1 == var2; // var1이 var2랑 서로 같다.
            bool rs6 = var1 != var2; // var1과 var2는 서로 다르다.
            ...
            bool res1 = val1 > 1 && val2 > 2;  // AND이므로 거짓거짓 = 거짓
            bool res2 = val1 > 0 && val2 > 1;  // AND이므로 참참 == 참 
            bool res3 = val1 > 1 || val2 > 2;  // OR이므로 거짓거짓 = 거짓
            bool res4 = val1 > 0 || val2 > 2;  // OR이므로 참거짓 = 참
            bool res5 = !(val1 > val2);        // !이 부정을 뜻함
