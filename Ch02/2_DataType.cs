...
namespace Ch02
{
    internal class _2_DataType
    {
        ...
        {
            // 정수형
            sbyte num1 = 127;         // 1btye, 부호 있는 정수, -128 ~ 127
            byte num2 = 255;          // 1btye, 부호 없는 정수, 0 ~ 255
            short num3 = 32767;       // 2btye, 부호 없는 정수, -32768 ~ 32767
            int num4 = 2147483647;    // 4btye, 부호 없는 정수, -2147483648 ~ 2147483647
            long num5 = 2147483648L;  // 8btye, 부호 없는 정수, 교재 참고
